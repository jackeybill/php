...
return array(
    ...
    'LOGIN_SECTION_TITLE' =>  'XX微场景用户登录-ja',
    'USER_EMAIL' =>  '帐号-ja',
    'USER_PASSWORD' =>  '密码-ja',
    'USER_REMEMBERME' =>  '记住密码',
    'USER_FORGETPW' => '忘记密码？',
    'USER_LOGIN' => '登录',
    'USER_REGISTER' => '注册',
    'USER_EMAILBOX' => '邮箱',
    'USER_GETPW' => '找回密码',
    'USER_REMEMBERED' => '我想起来了',
    'USER_RESET' => '重置',
    'USER_SUCCESSMSG' => '恭喜你，找回密码成功。',
    'USER_SENTPW' => '重置密码的链接已发送到你的 {{retrieve.email}}邮箱，登录邮箱重置密码吧！',
    'USER_SUGGEST' => '为了获得更好的使用，建议使用谷歌浏览器（chrome）、IE11浏览器。',
    'USER_LTPA' => '第三方账号登录',
